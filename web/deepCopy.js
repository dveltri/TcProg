...
function compare2objects( x, y ) 
{
	...
	{
		//LOG("constructor["+x.constructor+"!="+y.constructor+"]("+recal+")\n");
		return "constructor.";
	}
	...
	for ( var p in x ) 
	{
		...
		{
			//LOG("typeof["+p+"]("+recal+")\n");
			/*if(typeof( x[ p ] )=="number" || typeof( x[ p ] )=="undefined" ) 
			{
				if(isNaN(x[ p ]))
				{
					if(isNaN(y[ p ]==false))
		...
		if ( typeof( x[ p ] ) == "object" ) 
		{
			ret=compare2objects( x[ p ],  y[ p ] );
			if (ret!="") 
			{
				//LOG("compare2objects"+p+"["+x[ p ]+"]("+recal+")\n");
				return p+"."+ret+".";
			}
